        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    VoucherName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ...
                    Max_Discount = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetailCarts_DetailProducts_DetailProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DetailOrders_DetailProducts_DetailProductId",
                        column: x => x.DetailProductId,
                        principalTable: "DetailProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetailCarts_DetailProductId",
                table: "DetailCarts",
                column: "DetailProductId");

            migrationBuilder.CreateIndex(
                name: "IX_DetailOrders_DetailProductId",
                table: "DetailOrders",
                column: "DetailProductId");
